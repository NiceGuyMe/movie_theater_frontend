...
import Seat_Reserved_Table from "./Seat_Reserved_Table";
    ...
    return (
      <>
        <div class="topnav">
          ...
          <a href="./seat">seat</a>
          <a class="active" href="./seat_reserved">seat reserved</a>
        </div>
      </>
    );
  }
  ...
  function BODY(params) {
    ...
    useEffect(() =>{
        const promise = axios.get("http://localhost:8080/seatReserveds/");
